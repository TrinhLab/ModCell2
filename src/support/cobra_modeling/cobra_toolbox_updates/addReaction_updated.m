function [model, rxnIDexists] = addReaction_updated(model, rxnName, metaboliteList, stoichCoeffList, revFlag, lowerBound, upperBound, objCoeff, subSystem, grRule, geneNameList, systNameList, checkDuplicate, printLevel)
...
%       - Sergio Garcia 6/16/2017 made default print level 0 (does not
